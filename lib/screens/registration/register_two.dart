                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          CustomTextField(label: 'Password',prefixIcon: Icon(Icons.password), controller: globalController.passController!),
                          CustomTextField(label: 'Confirm Password',prefixIcon: Icon(Icons.lock), controller: globalController.confirmPassController!),
                          CustomTextField(label: 'Department',prefixIcon: Icon(Icons.account_balance), controller: globalController.departmentController!),
                          CustomTextField(label: 'Roll no.',prefixIcon: Icon(Icons.format_list_numbered), controller: globalController.rollNumController!),
                          SizedBox(
                            height: size.width * 0.1,
                          ),
                          RoundedButton(
